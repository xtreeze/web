...
function submenu() {
    ...
    const submenuBtn = document.querySelector('.with__submenu')
...
tl.fromTo(
    ...
    .fromTo(
        ...
        { y: 0, opacity: 1, duration: 1, delay: 0, stagger: 0.15 },
        0.6,
    )
    .fromTo(
        '.hero__btn-1',
...
if (document.querySelector('.body__main')) {
    ...
    const swiperServicesMain = new Swiper('.swiper__services', {
        // Navigation arrows
        navigation: {
            nextEl: '.next__slide',
            prevEl: '.prev__slide',
    ...
    // Swiper Quote Main
    const swiperQuote = new Swiper('.swiper__quote', {
        loop: true,
        autoplay: {
            delay: 2000,
            speed: 2000,
    ...
    function canvasApp() {
        ...
        function init() {
            ...
            turnSpeed = (2 * Math.PI) / 1300 //the sphere will rotate at this speed (one complete rotation every 1600 frames).
    ...
    if (window.innerWidth > 1200) {
        // Scrolltrigger Triangle Main
        gsap.registerPlugin(ScrollTrigger)

        gsap.to('.triangle__services', {
            scrollTrigger: {
                trigger: '.triangle__services',
                start: '-350 0',
                scrub: true,
                end: '+=1600',
            },
...
if (document.querySelector('.body__content')) {
    // Slider Blocks
    const swiperBLocks = new Swiper('.swiper__blocks', {
        // Navigation arrows
        navigation: {
            nextEl: '.arrow__next',
            prevEl: '.arrow__prev',
